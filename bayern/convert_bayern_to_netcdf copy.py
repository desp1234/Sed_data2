...
def process_station(station_id, discharge_dir, sediment_dir, output_dir):
    ...
    # Find all daily average (tmw) files for this station
...
def main():
    ...
    # Get all unique station IDs from discharge directory
    ...
    # Get all unique station IDs from sediment directory
    ...
    print(f"Found {len(discharge_ids)} stations with discharge data")
    print(f"Found {len(sediment_ids)} stations with sediment data")
    print(f"Found {len(common_ids)} stations with both datasets")
