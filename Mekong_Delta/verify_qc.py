    ...
    try:
        with nc.Dataset(filepath, 'r') as ds:
            ...
            if 'Q' in ds.variables and 'Q_flag' in ds.variables:
                ...
                fill_value = ds.variables['Q']._FillValue
                
                # Mask fill values to avoid checking them
            ...
            if 'SSC' in ds.variables and 'SSC_flag' in ds.variables:
                ...
                fill_value = ds.variables['SSC']._FillValue
                ...
                # Rule: SSC > 3000 should be flagged as 2 (Suspect)
                SSC_EXTREME_HIGH = 3000
            ...
            if 'SSL' in ds.variables and 'SSL_flag' in ds.variables:
                ...
                fill_value = ds.variables['SSL']._FillValue
...
if __name__ == "__main__":
    ...
    if not nc_files:
        ...
        for nc_file in sorted(nc_files): # Sort for consistent order
